...
public final class UUIDCreator implements java.io.Serializable, Comparable<UUIDCreator> {
     ...
     */
    public static UUIDCreator uuidFromKey(byte[] key) {
        MessageDigest md;
        try {
    ...
    public static UUIDCreator uuidFromKey(String key){
        return uuidFromKey(key.getBytes());
    }
