...
public class RedisServiceImpl extends RedisBaseDao implements RedisService {
    ...
    @Override
    public Long incr(final String key, final int db, final int expire) {
        return redisOperate(new IjedisOperate<Long>() {
            @Override
            public Long jedisOperate(Jedis jedis) {
                jedis.select(db);
    ...
    @Override
    public boolean redisLockOperate(final String lockName, final int lockTime, IredisLockOperate redisLockOperate) throws Exception {
        final String lockId = redisOperate(new IjedisOperate<String>() {
            @Override
